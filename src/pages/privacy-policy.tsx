...
function PrivacyPolicy() {
  return (
    <div className="page-privacy-policy">
      <p>
        This privacy policy serves as a straightforward explanation of how this
        website collects and handles your personal information. Please note that
        the term "this website" encompasses:
      </p>
      ...
      <p>
        Your connection to this website is fully encrypted via HTTPS, including
        (but not limited to) all stylesheets, scripts, and images. For more
        comprehensive details, see the{' '}
      ...
      <p>
        ...
        <a href="https://projects.calebevans.me/expressions/">Expressions</a>)
        have sharing features that work by uploading your content to this
        website's server. This content never leaves the server and is only used
        to enable this sharing functionality to function.
      </p>

      <h3>Google Analytics</h3>

      <p>
        This website uses Google Analytics. I only use this information to
      ...
      <p>
        If you choose to email me through this website, I will not share your
        email with anyone else, nor will I use it for marketing purposes.
      </p>
...
export async function getStaticProps() {
  return withGlobalStaticProps({
    props: {
      ...
      description:
        'The privacy policy for apps crafted by Caleb Evans, coder for Christ'
    }
  });
}
