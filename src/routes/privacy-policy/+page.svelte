<p>
  This privacy policy serves as a straightforward explanation of how this website collects and
  handles your personal information. Please note that the term "this website" encompasses:
</p>
...
<p>
  The apps on this website use the HTML5 Local Storage and IndexedDB APIs to store user-inputted
  data and preferences. All of this data remains on your computer, and can be cleared through your
  web browser. The data contains no personally-identifiable information except whatever information
  you may enter into the app. To be clear, however, this data is not sent to anyone.
</p>

<h3>Sharing Features</h3>

<p>
  Some of my apps (like
  <a href="https://projects.calebevans.me/expressions/">Expressions</a>) have sharing features that
  work by uploading your content to this website's server. This content never leaves the server and
...
<p>
  If you choose to email me through this website, I will not share your email with anyone else, nor
  will I use it for marketing purposes.
</p>

<h3>Changes</h3>

<p>
  This privacy policy may change at any time. When changes are made, the date at the top of this
